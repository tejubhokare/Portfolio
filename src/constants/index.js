...
export const PROJECTS = [
  {
    ...
    image: project1,
    description:
      "A fully functional Spotify clone application with features like song upload, user authentication, and personalized playlists.",
    technologies: ["NextJs", "React", "Tailwind", "Node.js", "PostgreSQL"],
  },
  {
...
export const CONTACT = {
  address: "29 Pemberton Avenue, North York, ON, M2M4L5 ",
  phoneNo: "+1 (437)-242-8053 ",
  email: "tejaswitanajibhokare@gmail.com",
};
